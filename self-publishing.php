...
<head>
    ...
    <title>WHD publishing - SelfPublishing</title>
            ...
            <div class="row feature-icons" data-aos="fade-up">
                <div class="text-center" style="margin-bottom:0px ;">
                    ...
                    <div class="col-xl-4 text-center" data-aos="fade-right" data-aos-delay="100">
                        <img src="assets/img/about-selfph.jpg" class="img-fluid p-4" alt="" />
                    </div>
                        ...
                        <div class="row align-self-center gy-4">
                            <div class="col-md-6 icon-box" data-aos="fade-up">
                                ...
                                <div>
                                    <h4>e-Book</h4>
                                    <p>
                                        We prepare your book for e-publishing, making it available on devices such as Kindle and iPad.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
                                ...
                                <div>
                                    <h4>Editing and proof reading</h4>
                                    <p>
                            ...
                            <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="300">
                                ...
                                <div>
                                    ...
                                    <p>
                                        Working with you, we will design a beautiful cover for your book complete with ISBN barcode and ready for print
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="400">
                                ...
                                <div>
                                    ...
                                    <p>
                                        Full retail quality, large or small quantities, in a fraction of the time and at a fraction of the cost
                                    </p>
                                </div>
                            </div>
                    ...
                    <p>WHD Publishing House offers services to the authors in assisting them to achieve their dreams of converting their manuscript into a Book. <br>We make it easy for any common man to publish their own book with our custom made Author
                        Kits.
                    </p>
                </div>
                <!-- End Feature Icons -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                    <div class="icon-box">
                        <div class="icon"><i class='bx bx-grid-vertical'></i></div>
                        <h4><a href="">Formatting</a></h4>
                        <p id="gfty1">The manuscript shall be paginated and made legible into a format of the book and the design the cover page that will be apt for the title and theme of the book</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
                    <div class="icon-box">
                        ...
                        <h4><a href="">Proofing</a></h4>
                        <p id="gfty1">The manuscript shall be ensured that it is proof read throughout the editing procedure and all the errors are nullified
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
                    <div class="icon-box">
                        <div class="icon"><i class='bx bxs-book-bookmark'></i></i>
                        </div>
                        <h4><a href="">E-Book</a></h4>
                        <p id="gfty1">The final draft of the book shall be made into an exclusively E-Publishing Format so that it can be publishing in any E-Reading platform</p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
                    <div class="icon-box">
                        ...
                        <p id="gfty1">The final book shall be printed into a paperback or hardback in the ideal dimensions that will aid the book
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
                    <div class="icon-box">
                        ...
                        <h4><a href="">Online Launching</a></h4>
                        <p id="gfty1">The book shall be launched online as in accordance how the client prefers to give a global face-off and international outreach
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
                    <div class="icon-box">
                        ...
                        <h4><a href="">PR & Reviewing</a></h4>
                        <p id="gfty1">After the launching, according to the client’s choice the reviewing assistance and press release process shall be catalysed</p>
                    </div>
                </div>
            ...
            <div class="container" data-aos="fade-up">
                <div class="row gx-0">
                    <div class="col-lg-6 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
                        <div class="content">
                            <h1>Our Support To Authors</h1>
                            <h2 id="supportcontent">
                                Get a wonderful experience by our expert managers at every step, Our team will simplify your publishing process
                            </h2>
                ...
                <div class="row ">
                    <div class="col-lg-3 ">
                        <div class="box " data-aos="fade-up " data-aos-delay="200 ">
                            ...
                            <!-- <ul class="list-unstyled ">
                                <li>Manuscript Proofreading</li>
                                <li>Basic & Comprehensive Editing</li>
                                <li>Language Translation</li>
                            </ul> -->
                            <p>Dicuss about your ideas with our expert team
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 mt-3 mt-lg-0 ">
                        <div class="box " data-aos="fade-up " data-aos-delay="400 ">
                            <img src="assets/img/cimage3.jpg " class="img-fluid " alt=" " />
                            <h3>PLANNING</h3>
                            <!-- <ul class="list-unstyled ">
                                ...
                                <li>Paperback/Hard-case binding</li>
                            </ul> -->
                            <p>Plan which Author Kit will suit you</p>
                        </div>
                    </div>

                    <div class="col-lg-3 mt-3 mt-lg-0 ">
                        <div class="box " data-aos="fade-up " data-aos-delay="400 ">
                            <img src="assets/img/cimage2.jpg " class="img-fluid " alt=" " />
                            <h3>SCRIPTING</h3>
                            <!-- <ul class="list-unstyled ">
                                <li>India online distribution</li>
                                <li>International Distribution</li>
                                <li>eBook Distribution</li>
                            </ul> -->
                            <p>Proceed on the writing of the manuscript</p>
                        </div>
                    </div>

                    <div class="col-lg-3 mt-3 mt-lg-0 ">
                        <div class="box " data-aos="fade-up " data-aos-delay="600 ">
                            <img src="assets/img/cimage5.jpg" class="img-fluid " alt=" " />
                            <h3>EDITING</h3>
                            <!-- <ul class="list-unstyled ">
                                <li>Social Media Marketing</li>
                                <li>Google Advertising</li>
                                <li>Flipkart Advertising</li>
                                <li>Amazon Advertising</li>
                                <li>Book Launch</li>
                            </ul> -->
                            <p>Edit the manuscript to match the outcome of the book</p>
                        </div>
                    </div>
                </div>
                <div class="row ">
                    ...
                    <div class="col-lg-3 mt-3 mt-lg-0 ">
                        <div class="box " data-aos="fade-up " data-aos-delay="600 ">
                            <img src="assets/img/cimage1.jpg" class="img-fluid " alt=" " />
                            <h3>DESIGNING</h3>
                            <!-- <ul class="list-unstyled ">
                                <li>Social Media Marketing</li>
                                <li>Google Advertising</li>
                            ...
                            <p>Design the cover page to enhance the looks of the book
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-3 mt-3 mt-lg-0 ">
                        <div class="box " data-aos="fade-up " data-aos-delay="600 ">
                            <img src="assets/img/cimage4.jpg " class="img-fluid " alt=" " />
                            <h3>ADVERTISING</h3>
                            <!-- <ul class="list-unstyled ">
                                <li>Social Media Marketing</li>
                                <li>Google Advertising</li>
                            ...
                            <p>Promotional materials and social media set up</p>
                        </div>
                    </div>
                    <div class="col-lg-3 mt-3 mt-lg-0 ">
                    ...
                    <div class="col-lg-6 ">
                        <form action="forms/contact.php " method="post " class="php-email-form ">
                            <div class="row gy-4 ">
                                ...
                                <div class="col-md-6 ">
                                    <input type="email " class="form-control " name="Number" placeholder="Number" required />
                                </div>
